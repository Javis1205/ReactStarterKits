...
// app folder
const appFolder = Path.resolve(__dirname, 'client')
const appEntry = Path.resolve(appFolder, 'index.jsx')
...
const conf = {
	...
	module: {
		rules: [
		    ...
		    include: [
		     		appEntry,
		     		Path.resolve(appFolder, 'config'),
		     		Path.resolve(appFolder, 'store'),
		     		Path.resolve(appFolder, 'ui'),
		    ],
		    loader: 'babel-loader',
		    options: {
		      cacheDirectory: true,
